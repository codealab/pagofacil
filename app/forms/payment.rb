class Payment
  ...
  validates :numero_tarjeta, length: { minimum: 16, maximum: 16 }
  validates :cvt, length: { minimum: 4, maximum: 4 }
  validates :telefono, length: { minimum: 10, maximum: 10 }
  validates :mes_expiracion, length: { minimum: 2, maximum: 2 }
  validates :anyo_expiracion, length: { minimum: 2, maximum: 2 }
  validates :celular, length: { minimum: 10, maximum: 10 }
  validates :telefono, length: { minimum: 10, maximum: 10 }
